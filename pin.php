...
function display_repin($picture_id,$pin_id,$sql_con){
                ...
                echo "<a class='btn btn-danger btn-sm' data-toggle='modal' data-target='#rp$pin_id$picture_id'>pin<span class='badge'>$no_rpin</span></a>";
...
function display_pins($result,$sql_con){
        while($row = mysqli_fetch_array($result)){
                ...
                echo "<div class='col-xs-3 thumbnail'>
                        <a data-toggle='modal' data-target='#$pin_id$picture_id'><img class='img-thumbnail' src='$path' style='height:189px;'/></a>";
